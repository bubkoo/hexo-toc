...
exports.insert = function (data) {
    ...
    // add class option
    if(options.class)data.content = data.content.replace("<!-- toc -->",'<div class="'+options.class+'Start"></div><!-- toc --><div class="'+options.class+'End"></div>');
...
exports.heading = function (data) {
    ...
    // add class option
    if(options.class)data.content = data.content.replace('<div class="'+options.class+'Start"></div>','<div class="'+options.class+'">').replace('<div class="'+options.class+'End"></div>','</div>');
